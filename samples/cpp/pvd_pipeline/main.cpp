...
int main(int argc, char *argv[]) {
    ...
    auto launch_str = g_strdup_printf("%s=%s ! %s ! capsfilter caps=\"%s\" ! "
                                      "gvadetect model=%s device=%s batch-size=%d model-proc=/home/zy/opvinomodels/model_proc/intel/object_detection/person-vehicle-bike-detection-2004.json  ! queue ! "
                                    //   "%s"
