...
class YOLOv5Converter : public YOLOBaseConverter {
  protected:
  ...
  public:
    YOLOv5Converter(const std::string &model_name, const ModelImageInputInfo &input_image_info,
